...
\\- \uline{Led} 4 teams of 5-6 members of international backgrounds (4+ nationalities). Two were complicated subsystems backend teams for the vehicle dispatch software \href{https://loogia.jp/}{Loogia}. Two were stream aligned teams in the \uline{0 to 1 phase}. 
\\- \uline{Developed} algorithms and backend APIs while leading two algorithm development teams (route search and combinatorial optimization). Led \uline{continuous feature improvements} including: expanding algorithm scalability to calculate large scale requests, achieving 20\% reduction in calculation time, and incorporating machine learning for continuous improvement of our travel time estimation logic. 
\\Scaling our algorithms allowed me to \uline{establish our \href{https://loogia.jp/consulting/}{professional consultation services}}, expanding our product offering and contributing upwards of 25\% of our revenue. 
\\- Kickstarted development of customizable data pipeline solution that connects with enterprise customers' core systems and allows for seamless integration with Loogia product suite. This product was pivotal in onboarding two enterprise customers which now constitute 20\% of total company MRR. 
\\- Spearheaded development of our mobile navigation solution for logistics service providers. 
\\- Voted company MVP in 3rd quarter of 2023 and 2nd quarter of 2025. 
...
\\- Led the Backend Team at Japan's largest Google Developer Student Club. %Led multiple teams using scrum and placed Top 50 in Google's annual Global Solution Challenge. 
