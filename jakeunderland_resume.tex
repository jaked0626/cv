...
\address{\faGithub{ github.com/jaked0626}$\:\vline\:$ \faLink \href{https://www.linkedin.com/in/jake-underland-720126201/}{LinkedIn}$\:\vline\:$\href{https://jaked0626.github.io/digital-biz-card/}{\raisebox{-0.05\height}\faGlobe \ MyWebsite} $\:\vline\:$ \faEnvelope{ jakez0626@gmail.com}}
\address{\faMapMarker{ 6-60-8 Takinogawa, Kita, Tokyo, JPN 114-0023 }$\vline$ \faPhone (+81)90 1461 8440} % Your address
...
{\bf \href{https://www.optimind.tech/}{Optimind Inc}} {\textit{- Software Developer/Senior Product Manager }} \hfill {\em Apr 2022 - Present} 
\begin{itemize}
\item \uline{Led} 4 teams of 5-6 members of international backgrounds (4+ nationalities). Two were complicated subsystems backend teams for the vehicle dispatch software \href{https://loogia.jp/}{Loogia}. Two were stream aligned teams in the \uline{0 to 1 phase}. 
\item \uline{Developed} algorithms and backend APIs while leading two algorithm development teams (route search and combinatorial optimization). Led \uline{continuous feature improvements} including: expanding algorithm scalability to calculate large scale requests, achieving 20\% reduction in calculation time, and incorporating machine learning for continuous improvement of our travel time estimation logic. 
\item Scaling our algorithms allowed me to \uline{establish our \href{https://loogia.jp/consulting/}{professional consultation services}}, expanding our product offering and contributing upwards of 25\% of our revenue. 
\item Kickstarted development of customizable data pipeline solution that connects with enterprise customers' core systems and allows for seamless integration with Loogia product suite. This product was pivotal in onboarding two enterprise customers which now constitute 20\% of total company MRR. 
\item Spearheaded development of our mobile navigation solution for logistics service providers. 
\item Served as \uline{Leader, Product Manager, and Product Owner} in our partner project with Boston Consulting Group and Japan International Cooperation Agency to \href{https://www.jica.go.jp/english/about/dx/project/detail/1569316_68029.html}{provide sustainable retail logistics platform for the Cambodian government}. This was Optimind's first project overseas. 
\item Voted company MVP in 3rd quarter of 2023, 2nd quarter of 2025, and 3rd quarter of 2025.  
\item From Jun 2026 onwards, leading business development efforts directly under CEO. 
\end{itemize}

{\bf Waseda University School of Political Science and Economics} {\textit{ - RA }} \hfill {\em Feb 2022 - Aug 2022} 
\begin{itemize}
\item \uline{Econometric analysis} of electricity usage in developing countries. Implemented linear models, IV models, dynamic structural estimation with GMM in R. 
\end{itemize}
...
\begin{itemize}
\item Led the Backend Team at Japan's largest Google Developer Student Club. %Led multiple teams using scrum and placed Top 50 in Google's annual Global Solution Challenge. 
\end{itemize}
...
%\\- \uline{Optimized} resource allocation using \uline{reinforcement learning} resulting in 20\% less food waste at unmanned coworking spaces. 
...
\begin{itemize}
\item \href{http://www2.cie-waseda.jp/glfp/jp/about/program.html}{Global Leadership Fellows' Program} fellow. Advisors: \href{https://tadaohoshino.wordpress.com/}{Tadao Hoshino}, \href{https://waseda.pure.elsevier.com/en/persons/hisatoshi-tanaka}{HisatoshiTanaka}.
\end{itemize}
...
\begin{itemize}
\item Exchange program. Took courses in econometrics and computer science. Participated in research assistantship. 
...
Programming Languages: \ & Python, Go, C++, SQL, R \\
...
\begin{itemize}
\item Japan Statistical Society Certificate Level 3, Best Grade, 2019
\item Waseda University Arai Takanobu Scholarship
\end{itemize}
\end{rSection}
